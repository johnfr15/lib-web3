...
import { swap, addLiquidity, removeLiquidity, create_new_pool } from "./src/mySwap"
...
export default { swap, addLiquidity, removeLiquidity, create_new_pool, Constant, Utils }