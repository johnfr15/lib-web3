...
import { TICKER, ROUTER_ABI, ROUTER_ADDRESS, TOKENS, ZERO_ADDRESS, ERC20_ABI, WMATIC } from "../config/constants";
import { AddLiquidityTx } from "../types";
import { get_token, get_balance, is_balance, is_native } from "../utils";
import { Token, Pair, Fetcher, TokenAmount } from "@uniswap/sdk";
import { UniswapV2Router01Interface } from "../typechain-types/contracts/UniswapV2Router01"
...
export const get_add_liq_tx = async(
    ...
    try {
        ...
        const pool: Pair = await Fetcher.fetchPairData( token0, token1 )
